...
<table width="1180" border="0" cellpadding="0" cellspacing="0" class="dh">
	<tr>
		...
		<table width="1180" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td><img src="images/TopRx02_r1_c1.jpg" width="1179" height="230" /></td>
			</tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="354" valign="top">
					<div class="left">
						<h2>新闻动态</h2>
						<? @sys_GetEcmsInfo(5,10,32,0,0,13,0);?>
					</div>
				</td>
				<td valign="top">
					<div class="right">
						<h3><?=$ecms_gr[title]?> </h3>
						<div>
							<p><?=strstr($ecms_gr[newstext],'[!--empirenews.page--]')?'[!--newstext--]':$ecms_gr[newstext]?></p>
						</div>
					</div>
				</td>
			</tr>
