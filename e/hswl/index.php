...
<title>鸿商网络管理系统 － 最安全、最稳定的开源CMS系统</title>
<link rel="stylesheet" href="loginimg/css.css" type="text/css">
<base onmouseover="window.status='鸿商网络管理系统(HungCMS) － 最安全、最稳定的开源CMS系统';return true">
<script>
if(self!=top)
{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="73%" height="30">Powered by <strong>HungCMS</strong> 
              <font color="#FF9900"><strong>7.0</strong></font> &copy; 2002-2014</td>
            <td width="8%">&nbsp;</td>
          </tr>
        </table></td>
    </tr>
